...
<head>
  ...
  <style>
    ...
    html.dark-theme .auth-card { background: #0f1724 !important; border-color: rgba(255,255,255,0.06) !important; box-shadow: 0 20px 60px rgba(2,6,23,0.7) !important; }
    ...
    html.dark-theme .field input, html.dark-theme .field select {
    ...
    html.dark-theme .section-label { color: #9aa5b4 !important; }
